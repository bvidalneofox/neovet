...
let BuscadorMascotasComponent = class BuscadorMascotasComponent {
...
BuscadorMascotasComponent.ctorParameters = () => [
...
let NuevaVacunaComponent = class NuevaVacunaComponent {
    constructor(_snotify, _mascotasService, _vacunasService, _antiparasitarioService) {
        this._snotify = _snotify;
        this._mascotasService = _mascotasService;
...
let VerCalendarioComponent = class VerCalendarioComponent {
    constructor(_snotify, _eventosService) {
        this._snotify = _snotify;
...
let VerConsultasActivasComponent = class VerConsultasActivasComponent {
    constructor(_snotify, _consultasService) {
        this._snotify = _snotify;
        this._consultasService = _consultasService;
...
let VerHistorialConsultasComponent = class VerHistorialConsultasComponent {
    constructor(_snotify, _consultasController) {
        this._snotify = _snotify;
...
let VerHistorialHospitalizacionesComponent = class VerHistorialHospitalizacionesComponent {
    constructor(_snotify, _hospitalizacionesService) {
        this._snotify = _snotify;
...
VerHistorialHospitalizacionesComponent.ctorParameters = () => [
    { type: ng_snotify__WEBPACK_IMPORTED_MODULE_2__["SnotifyService"] },
...
let VerHospitalizacionesActivasComponent = class VerHospitalizacionesActivasComponent {
    constructor(_snotify, _hospitalizacionesService) {
        this._snotify = _snotify;
        this._hospitalizacionesService = _hospitalizacionesService;
...
VerHospitalizacionesActivasComponent.ctorParameters = () => [
    { type: ng_snotify__WEBPACK_IMPORTED_MODULE_3__["SnotifyService"] },
...
/* harmony import */ var _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! @auth0/angular-jwt */ "./node_modules/@auth0/angular-jwt/fesm2015/auth0-angular-jwt.js");
...
let FichaClienteComponent = class FichaClienteComponent {
    constructor(_clientesService, rutaActiva) {
...
FichaClienteComponent.ctorParameters = () => [
...
let FichaClinicaComponent = class FichaClinicaComponent {
    constructor(_snotify, _consultasService, location, rutaActiva) {
        this._snotify = _snotify;
        this._consultasService = _consultasService;
        this.rutaActiva = rutaActiva;
        this.rutaLogo = localStorage.getItem('rutaLogo');
...
let FichaConsultaComponent = class FichaConsultaComponent {
    constructor(_snotify, _consultasService, router, rutaActiva) {
        this._snotify = _snotify;
        this._consultasService = _consultasService;
        this.router = router;
        this.rutaActiva = rutaActiva;
...
FichaConsultaComponent.ctorParameters = () => [
    { type: ng_snotify__WEBPACK_IMPORTED_MODULE_3__["SnotifyService"] },
    { type: src_app_servicios_consultas_service_service__WEBPACK_IMPORTED_MODULE_4__["ConsultasServiceService"] },
...
let FichaHospitalizacionComponent = class FichaHospitalizacionComponent {
    constructor(_snotify, router, rutaActiva, _hospitalizacionService) {
        this._snotify = _snotify;
        this.router = router;
        this.rutaActiva = rutaActiva;
...
FichaHospitalizacionComponent.ctorParameters = () => [
    { type: ng_snotify__WEBPACK_IMPORTED_MODULE_4__["SnotifyService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: src_app_servicios_hospitalizaciones_service__WEBPACK_IMPORTED_MODULE_3__["HospitalizacionesService"] }
...
let FichaMascotaComponent = class FichaMascotaComponent {
    constructor(_mascotasService, _snotify, location, rutaActiva, _vacunasService, _consultasService, _clientesService, _antiparasitarioService) {
        this._mascotasService = _mascotasService;
        this._snotify = _snotify;
        this.rutaActiva = rutaActiva;
        this._vacunasService = _vacunasService;
...
let InicioEstadisticasComponent = class InicioEstadisticasComponent {
    constructor(_snotify, _estadisticasService) {
        this._snotify = _snotify;
...
InicioEstadisticasComponent.ctorParameters = () => [
    { type: ng_snotify__WEBPACK_IMPORTED_MODULE_3__["SnotifyService"] },
...
let LoginComponent = class LoginComponent {
    constructor(_loginService, router, _configuracionesSercice) {
        this._loginService = _loginService;
        this.router = router;
...
let NuevaPasswordComponent = class NuevaPasswordComponent {
    constructor(route, _loginService) {
        this.route = route;
        this._loginService = _loginService;
        this.token = null;
...
NuevaPasswordComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let AntiparasitariosService = class AntiparasitariosService {
    constructor(_http) {
        this._http = _http;
        this.url = '';
        this.url = _global__WEBPACK_IMPORTED_MODULE_3__["global"].url;
    }
    setAntiparasitario(datosMascota, nombreAntiparasitario) {
    ...
    getAntiparasitarioPorIdMascota(id) {
        return this._http.get(this.url + "getAntiparasitarioPorIdMascota/" + id);
    }
};
AntiparasitariosService.ctorParameters = () => [
...
let ConsultasServiceService = class ConsultasServiceService {
    ...
    getUltimasConsultasPorIdMascota(id) {
    ...
    getConsultasInactivasPorFechas(fechaInicio, fechaFin) {
    ...
    setProcedimientoConsulta(idConsulta, procedimientoConsulta, peso, checkHosp, numeroCamilla, motivoHospitalizacion, idMascota) {
        let form = new FormData();
    ...
    cambiarEstadoConsulta(id, metodo) {
        let form = new FormData();
...
let EstadisticasService = class EstadisticasService {
    ...
    getEstadisticasConsultasPorFecha(fechaIni, fechaFini) {
    ...
    getEstadisticasHospitalizacionesPorFecha(fechaIni, fechaFini) {
    ...
    getEstadisticasClientesPorFecha(fechaIni, fechaFini) {
    ...
    getEstadisticasMascotasPorFecha(fechaIni, fechaFini) {
...
GuardianService.ctorParameters = () => [
...
let HospitalizacionesService = class HospitalizacionesService {
    constructor(_http) {
        this._http = _http;
        this.url = '';
        this.url = _global__WEBPACK_IMPORTED_MODULE_3__["global"].url;
    ...
    getHospitalizacionesInactivasPorFechas(fechaInicio, fechaFin) {
        return this._http.get(this.url + "getHospitalizacionesInactivasPorRangoFecha/" + fechaInicio + '/' + fechaFin);
    }
    getHospitalizacionPorId(id) {
        return this._http.get(this.url + "getHospitalizacionPorId/" + id);
    }
    setSeguimiento(descripcion, archivo, id, estadoEsterilizacion, idMascota) {
        let form = new FormData();
...
HospitalizacionesService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let LoginService = class LoginService {
    ...
    cambiarPassOlvidada(formDatos, token) {
        let form = new FormData();
...
let UsuariosService = class UsuariosService {
    ...
    changePasswordUser(formCliente, formPass) {
        let form = new FormData();
        form.append("id", formCliente.id);
