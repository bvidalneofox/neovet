...
module.exports = ".but-card{\r\n    background-image: linear-gradient(\r\n        to bottom,\r\n        rgba(172, 99, 240, 0.52),\r\n        rgba(172, 99, 240, 0.73)\r\n      ),\r\n      url(\"https://www.petmd.com/sites/default/files/Acute-Dog-Diarrhea-47066074.jpg\");\r\n  }\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var FichaConsultaComponent = /** @class */ (function () {
    ...
    FichaConsultaComponent.prototype.setProcedimientoConsulta = function () {
        var _this = this;
        this._consultasService.setProcedimientoConsulta(this.idConsulta, this.procedimientoConsulta, this.pesoMascota, this.hospitalizacionCheckBox, this.motivoHospitalizacion, this.idMascotaHospitalizacion).subscribe(function (response) {
            if (response.estado == 'success') {
                _this._snotify.success(response.mensaje, {
                    timeout: 2000,
                    showProgressBar: true,
...
var ConsultasServiceService = /** @class */ (function () {
    ...
    ConsultasServiceService.prototype.setProcedimientoConsulta = function (idConsulta, procedimientoConsulta, peso, checkHosp, motivoHospitalizacion, idMascota) {
        var form = new FormData();
